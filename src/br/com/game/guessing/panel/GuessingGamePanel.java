package br.com.game.guessing.panel;
 ...
 */
public class GuessingGamePanel extends javax.swing.JFrame {
     ...
     * @param attempts
     */
    public GuessingGamePanel(int maxNumber, int minNumber, int attempts) {
